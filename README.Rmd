...
- [`R/`](https://github.com/MikeHedde/SoilWarm/tree/main/R):
...
Launch the [`make.R`](https://github.com/MikeHedde/SoilWarm/tree/main/make.R)
file with:
...
check out our [Contributor Guidelines](https://github.com/MikeHedde/SoilWarm/blob/main/CONTRIBUTING.md).
