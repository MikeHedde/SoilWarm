# Contributing to SoilWarm

First off, thanks for taking the time to contribute to `SoilWarm`!
...
`SoilWarm` uses the `lower_snake_case`.
...
[Issues](https://github.com/MikeHedde/SoilWarm/issues) that might help 
...
- Make sure that you are using the latest version of `SoilWarm`.
- Determine if your bug is really a bug and not an error on your side.
- To see if other users have experienced (and potentially already solved) the 
same issue you are having, check if there is not already a bug report existing 
for your bug or error in the [bug tracker](https://github.com/MikeHedde/SoilWarm/issues?q=label%3Abug).



### How do I submit a bug report?

We use [GitHub Issues](https://github.com/MikeHedde/SoilWarm/issues) to 
...
- Make sure that you are using the latest version of `SoilWarm`.
- Read the [documentation](https://github.com/MikeHedde/SoilWarm/)
carefully and find out if the functionality is already covered.
- Perform a [search](https://github.com/MikeHedde/SoilWarm/issues) to 
...
- Explain why this enhancement would be useful to most `SoilWarm` users.
...
3. Submit a [Pull Request](https://docs.github.com/en/get-started/quickstart/contributing-to-projects#making-a-pull-request) on the [original repo](https://github.com/MikeHedde/SoilWarm/compare).
